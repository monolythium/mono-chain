...
//
// source: https://github.com/evmos/evmos/blob/eca13ef2521a9ef13c32e80b1b147230bdb155b5/types/chain_id.go // v20.0.0
package cmd
...
func ParseChainID(chainID string) (*big.Int, error) {
	...
	if matches == nil || len(matches) != 4 || matches[1] == "" {
		return nil, errorsmod.Wrapf(sdkerrors.ErrInvalidChainID, "%s: %v", chainID, matches)
	}
