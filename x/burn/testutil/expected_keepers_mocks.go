...
// Source: x/burn/types/expected_keepers.go
//
// Generated by this command:
//
//	mockgen -source=x/burn/types/expected_keepers.go -package testutil -destination x/burn/testutil/expected_keepers_mocks.go
//
